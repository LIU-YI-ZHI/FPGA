...
HD_PWD='D:/FPGA/homework/double_pingpong/double_pingpong.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log HW_1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source HW_1.tcl -notrace
